...
var1=StringVar()
input_1=Entry(a,fg="green",font=("Arial",20),borderwidth = 7,textvariable=var1,bg="grey").place(x=240,y=420)
text=Label(a,text="Message",font=("Arial",22,"bold")).place(x=330,y=475)
var2=StringVar()
input_2=Entry(a,fg="green",font=("Arial",20),borderwidth = 7,textvariable=var2,bg="grey").place(x=240,y=520)
